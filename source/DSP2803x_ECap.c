...
// GpioCtrlRegs.GPAPUD.bit.GPIO5 = 0;      // Enable pull-up on GPIO5 (CAP1)
   //GpioCtrlRegs.GPAPUD.bit.GPIO19 = 1;     // Enable pull-up on GPIO19 (CAP1)
...
// GpioCtrlRegs.GPAQSEL1.bit.GPIO5 = 0;    // Synch to SYSCLKOUT GPIO5 (CAP1)
  //GpioCtrlRegs.GPAQSEL2.bit.GPIO19 = 0;   // Synch to SYSCLKOUT GPIO19 (CAP1)
   ...
   GpioCtrlRegs.GPAQSEL2.bit.GPIO24 = 2;   // Synch to SYSCLKOUT GPIO24 (CAP1)
...
// GpioCtrlRegs.GPAMUX1.bit.GPIO5 = 3;     // Configure GPIO5 as CAP1
  // GpioCtrlRegs.GPAMUX2.bit.GPIO19 = 1;    // Configure GPIO19 as CAP1
